...
- Обновляем\устанавливаем пакеты и ставим ноду `composer update` и `npm install`, `npm run dev` прописывать руками не надо, он запускается при старте контейнера 
